...
const Navbar = () => {
  ...
  return (
    <div className='flex fixed top-0 w-full items-start justify-between z-4'>
     ...
     }} className='lg:h-17 h-10 bg-black relative lg:w-[16vw] w-44'>
        <div ref={navGreenRef} className='bg-[#D3FD50] transition-all absolute top-0 h-0 w-full'>
        
        </div>
        <div className='relative flex flex-col justify-center items-end lg:px-12 px-8 h-full lg:gap-1.5 gap-0.5'>
